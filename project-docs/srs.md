...
1. INTRODUCTION
1.1 Purpose
The GFZA Internal Operations Portal(IOP) is an internal enterprise system designed to digitize and streamline internal communication, HR operations, MIS workflows, asset management, conference room booking, and employee service processes.
...
Laravel + Blade (Fast, secure, efficient)
Mobile-first UI
...
The system acts as a central internal portal for all staff.
 It replaces all paper-based processes such as memos, food selection sheets, MIS troubleshooting forms, computer assignment tracking, and room reservation logs.
...
If conflict, append number (e.g.,  mclement2@gfzaiop.com, mclement2@gfzaiop.com)
MIS dashboard shows:
...
MIS reassign asset to new user
...
3.6 Community Chat (to be added to future features)
Functional Requirements
