...
|---------|------|--------|-------------|-------|
| **H1** | 32px | 700 (Bold) | 40px | Page titles, main dashboard headings |
| **H2** | 24px | 600 (Semibold) | 32px | Section headings, card titles |
| **H3** | 20px | 600 (Semibold) | 28px | Subsections, module titles |
| **H4** | 16px | 600 (Semibold) | 24px | Component titles, labels |
| **Body L** | 16px | 400 (Regular) | 24px | Primary body text, descriptions |
| **Body M** | 14px | 400 (Regular) | 20px | Standard text, table content |
| **Body S** | 12px | 400 (Regular) | 18px | Captions, helper text, timestamps |
| **Button** | 14px | 600 (Semibold) | 20px | All button labels |
| **Caption** | 12px | 500 (Medium) | 16px | Field labels, small headings |
...
- **Padding:** 24px (top, left, right, bottom)
...
**Color Accent:** `#00c73f` for consistency
