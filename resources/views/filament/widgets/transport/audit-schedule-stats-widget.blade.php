...
<x-filament-widgets::widget>
    ...
    <div class="flex flex-col xl:flex-row gap-4 overflow-x-auto pb-2">
        {{-- Total Audits --}}
        <div class="flex-1 min-w-[160px] rounded-xl px-6 py-5 text-white shadow-md" style="background-color: #1a73e8;">
        ...
        {{-- Scheduled --}}
        <div class="flex-1 min-w-[160px] rounded-xl px-6 py-5 text-white shadow-md" style="background-color: #6b7280;">
            <div class="flex items-center gap-3">
        ...
        {{-- In Progress --}}
        <div class="flex-1 min-w-[160px] rounded-xl px-6 py-5 text-white shadow-md" style="background-color: #f59e0b;">
            <div class="flex items-center gap-3">
        ...
        {{-- Completed --}}
        <div class="flex-1 min-w-[160px] rounded-xl px-6 py-5 text-white shadow-md" style="background-color: #10b981;">
            <div class="flex items-center gap-3">
        ...
        {{-- Completion Rate --}}
        <div class="flex-1 min-w-[160px] rounded-xl px-6 py-5 text-white shadow-md" style="background-color: {{ $stats['completionRate'] >= 75 ? '#10b981' : ($stats['completionRate'] >= 40 ? '#f59e0b' : '#ef4444') }};">
            <div class="flex items-center gap-3">
    ...
    <div class="mt-6 flex flex-row gap-4">
        <div class="flex-1 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-5 py-4 text-center shadow-sm">
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Internal</div>
            <div class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['internalCount'] }}</div>
        </div>
        <div class="flex-1 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-5 py-4 text-center shadow-sm">
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">External</div>
            <div class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['externalCount'] }}</div>
        </div>
        <div class="flex-1 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-5 py-4 text-center shadow-sm">
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Compliance</div>
            <div class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['complianceCount'] }}</div>
        </div>
        <div class="flex-1 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-5 py-4 text-center shadow-sm">
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Monitoring</div>
