    ...
    <div class="flex flex-wrap gap-3 items-stretch">
        ...
        <div class="flex-1 min-w-[160px] rounded-lg px-4 py-3 text-white" style="background-color: #6b7280;">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <div class="text-xs font-medium opacity-90">Today</div>
                    <div class="text-sm font-bold">{{ $stats['date'] }}</div>
                    <div class="text-xs opacity-80">{{ $stats['time'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 min-w-[120px] rounded-lg px-4 py-3 text-white" style="background-color: #10b981;">
            <div class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <div class="text-xl font-bold">{{ $stats['onTime'] }}</div>
                    <div class="text-xs opacity-80">{{ $stats['onTimePct'] }}%</div>
                </div>
            </div>
        </div>
